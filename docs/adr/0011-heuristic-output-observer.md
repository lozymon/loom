...
- **Docs reconciled:** [`CONTEXT.md`](../../CONTEXT.md) (Pane opacity clause), [`AGENT_FIRST_PLAN.md`](../../AGENT_FIRST_PLAN.md) (§1.1 load-bearing principle + the opacity row), and [ORCHESTRATION-IDEAS.md](../ORCHESTRATION-IDEAS.md) #5 point here.
